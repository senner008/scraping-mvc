...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return stateInit; });\n/* harmony import */ var _renderList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renderList */ \"./Client/renderList.ts\");\n\r\nfunction stateInit(obj, filterFunc) {\r\n    return {\r\n        setValue(prop, val) {\r\n            if (!obj.hasOwnProperty(prop)) {\r\n                throw \"property not in object\";\r\n            }\r\n            obj[prop] = val;\r\n            Object(_renderList__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(filterFunc());\r\n        },\r\n        getValue(prop) {\r\n            if (!obj.hasOwnProperty(prop)) {\r\n                throw \"property not in object\";\r\n            }\r\n            return obj[prop];\r\n        },\r\n        getObject() {\r\n            return obj;\r\n        }\r\n    };\r\n}\r\n;\r\n\n\n//# sourceURL=webpack:///./Client/stateInit.ts?");
